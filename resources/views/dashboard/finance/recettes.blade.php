    ...
    <div class="main-content" id="mainContent">
        ...
        <div  class="">
            <div class="dashboard-header">
                <h1>Gestion des <span class="highlight">Recettes</span></h1>
                <div class="btn-group">
                    <button class="btn btn-primary" data-bs-toggle="modal"  data-bs-target="#recetteModal">
                        <i class="fas fa-plus me-1"></i> Nouveau recette
                    </button>
                </div>
            </div>
